...
{
  MPU6050WriteRegister(MPU6050_PWR_MGMT_1, 0x00);//解除休眠状态
 MPU6050WriteRegister(MPU6050_PWR_MGMT_2, 0x00);
  //(SMPLRT_DIV, 0x07); //有时会需要选择数据输出率不设置则默认最高
  MPU6050WriteRegister(MPU6050_CONFIG, 0x06);//低通滤波器带宽5Hz
  MPU6050WriteRegister(MPU6050_GYRO_CONFIG, 0x08);//不自检   ±500 °/s
