...
#include "MK60_i2c.h"
#define   L3G4200_I2C_Moudle         I2C1
/* Exported types ------------------------------------------------------------*/
...
#define I_AM_L3G4200D			        0x69//0xD3 
...
#define L3G4200WriteRegister(regAddr, regValue)         WriteReg(regAddr, regValue)
#define L3G4200ReadRegister(regAddr,Data)              ReadReg(regAddr,&Data)
