...
#include "MK60_i2c.h"
#define   MMA845x_I2C_Moudle         I2C1
//#define MMA845x_I2C_ADDRESS     0x1D   // SA0 = 1
#define MMA845x_I2C_ADDRESS    0x1C   // SA0 = 0

#define MMA845xWriteRegister(regAddr, regValue)		i2c_write_reg(MMA845x_I2C_Moudle,MMA845x_I2C_ADDRESS, regAddr, regValue)
#define MMA845xReadRegister(regAddr)			i2c_read_reg(MMA845x_I2C_Moudle,MMA845x_I2C_ADDRESS, regAddr)
...
#define MMA845xReadDoubleRegisters(regStartAddr)         i2c_read_double_reg(MMA845x_I2C_Moudle,MMA845x_I2C_ADDRESS,regStartAddr)
...
#define DATA_STATUS_ZYXDR_MASK          0x08u
#define DATA_STATUS_ZDR_MASK            0x04u
