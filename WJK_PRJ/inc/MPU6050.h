...
#define MPU6050_ADDRESS_AD0_LOW         0x68 // address pin ad0 low (GND), default
#define MPU6050_ADDRESS_AD0_HIGH        0x69 // address pin ad0 high (VCC)
//以下几个宏定义需要修改 以适应i2c模块
#include "MK60_i2c.h"
#define MPU6050_I2C_Moudle              I2C1
#define MPU6050_ADDRESS                 MPU6050_ADDRESS_AD0_LOW

#define MPU6050WriteRegister(regAddr, regValue)		i2c_write_reg(MPU6050_I2C_Moudle,MPU6050_ADDRESS, regAddr, regValue)
#define MPU6050ReadRegister(regAddr)			i2c_read_reg(MPU6050_I2C_Moudle,MPU6050_ADDRESS, regAddr)
#define MPU6050xReadMultiRegisters(regStartAddr)         i2c_read_double_reg(MPU6050_I2C_Moudle,MPU6050_ADDRESS,regStartAddr)
